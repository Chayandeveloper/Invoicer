...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Create Quotation</h1>
                <p class="text-sm text-gray-500 font-medium">Issue a new professional quotation</p>
            </div>
        </div>

        <form action="{{ route('quotations.store') }}" method="POST" class="space-y-8">
            @csrf
            ...
            <div class="bg-white p-6 sm:p-8 rounded-2xl border border-gray-100 shadow-sm space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <input type="hidden" name="sender_logo" id="logo">
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-6 sm:p-8 rounded-2xl border border-gray-100 shadow-sm space-y-6 text-gray-800">
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <h2 class="text-lg font-black text-gray-800 uppercase tracking-widest text-[11px]">Quotation Details
                        </h2>
                    </div>

                    <div>
                        <label
                            class="block text-[10px] font-black text-gray-400 uppercase mb-2 ml-1 tracking-widest">Quotation
                            Number</label>
                        <input type="text" name="quotation_number" value="QT-{{ rand(1000, 9999) }}" required
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label
                                class="block text-[10px] font-black text-gray-400 uppercase mb-2 ml-1 tracking-widest">Date</label>
            ...
            <div class="flex justify-end">
                <div class="w-full lg:w-1/2 bg-white p-8 rounded-2xl border border-gray-100 shadow-sm space-y-4">
                    <div class="flex justify-between items-center pb-2 border-b border-gray-50">
                        ...
                        <span id="subtotal-display" class="font-bold text-gray-700">Rs. 0.00</span>
                    </div>
                    <div class="flex justify-between items-center pb-2 border-b border-gray-50">
                    ...
                    <div class="flex justify-between items-center pt-2">
                        ...
                        <span id="total-display" class="text-3xl font-black text-primary italic tracking-tighter">Rs.
                            0.00</span>
                    </div>
                </div>
            </div>
